<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login1.aspx.cs" Inherits="website.login1" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
    ...
    <div class="login_1 p-4 m-auto">
	 ...
	 <p>Login your account</p>
	  <form id="form1" runat="server">
        ...
        <asp:TextBox ID="TextBox1" required="" Type="email" class="form-control" runat="server" placeholder="email"></asp:TextBox>
	 
	
        <h6 class="mt-4">Password</h6>
	  <asp:TextBox ID="TextBox2" type="password" required="" class="form-control" runat="server" placeholder="password"></asp:TextBox>
...
I agree with the <a class="col_oran" href="#">Terms Of Service</a>
    ...
    <h6 class="mt-4 mb-0">
        ...
        <asp:Button class="button" ID="button" runat="server" Text="Login" OnClick="button_Click" />
        <%--<a class="button" href="#">Register  --%>
       <%-- <i class="fa fa-location-arrow ms-1"></i></a></h6>--%>
	<p class="mt-4 mb-0">Don't have an account? <a class="col_oran" href="register1.aspx">Register</a></p>
	</div>
   </div>
  </div>  
 </div>
