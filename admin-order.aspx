<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-order.aspx.cs" Inherits="website.admin_order" %>
       ...
       <div class="row" style="margin:5%; border:0px; position:relative; bottom:500px; width:1350px; ">
            <table border="0"  >
             <asp:GridView ID="GridView1" runat="server" class="table table-striped table-dark border-white"></asp:GridView>
                 <asp:GridView ID="GridView2" runat="server" class="table table-striped table-dark border-white"></asp:GridView>
            </table>
        </div>
