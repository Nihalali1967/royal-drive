<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="website.index2" %>
...
<div class="container-xl">
  <div class="row footer_1">
    <div class="col-md-4">
	 <div class="footer_1i">
	  <h4><a href="index.aspx"><i ></i> CAR  <span class="fw-normal"></span>RENTAL</a></h4>
	 <br>
	  <h6 class="mt-3 fw-normal"><i ></i>Ernakulam , Fort Kochi , kerala</h6>
	  <h6 class="mt-3 fw-normal"><a href="#"><i ></i>+91 9898989898</a></h6>
	  <h6 class="mt-3 mb-0 fw-normal"><a href="#"><i ></i> prestigedrive@gmail.com</a></h6>
	 </div>
	</div>
