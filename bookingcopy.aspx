<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookingcopy.aspx.cs" Inherits="website.bookingcopy" %>
...
<div class="container-xl" style="
    margin: 1;
    margin-top: 0px;">
 <div class="booking_m clearfix bg-white" style="
    padding-top:66px;">
 ...
 <div class="row booking_2 mt-4">
  <div class="col-md-4 col-sm-6">
   <div class="booking_2i">
    <h6 class="mb-3"><i class="fa fa-car me-1 col_oran"></i> Your Car</h6>
	   <asp:label ID="TextBox1"  runat="server"  class="form-control h-50"   ></asp:label>
   </div>
  </div>
  <div class="col-md-4 col-sm-6">
   <div class="booking_2i">
	...
	<div class="booking_2i1 row">
	 <div class="col-md-8">
	  <div class="booking_2i1l">
		  <asp:TextBox ID="TextBox2" runat="server" type="date"  class="form-control"></asp:TextBox>
  ...
  <div class="col-md-4 col-sm-12">
   <div class="booking_2i">
	...
	<h6 class="text-center mb-0">
		<asp:Button ID="Button1" runat="server" Text="Submit"  class="button pt-3 pb-3 d-block" OnClick="Button1_Click"/></h6>
